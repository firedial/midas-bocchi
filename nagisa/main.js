...
var $author$project$Main$Model = F3(
	function (key, page, env) {
		return {env: env, key: key, page: page};
	});
...
var $author$project$Page$Account$init = F2(
	function (name, count) {
		return _Utils_Tuple2(
			A2($author$project$Page$Account$Model, name, count),
			$elm$core$Platform$Cmd$none);
	});
var $author$project$Page$Top$Model = F3(
	function (name, count, env) {
		return {count: count, env: env, name: name};
	});
var $author$project$Page$Top$init = F3(
	function (name, count, env) {
		return _Utils_Tuple2(
			A3($author$project$Page$Top$Model, name, count, env),
			$elm$core$Platform$Cmd$none);
	});
		...
		if (maybeRoute.$ === 'Nothing') {
			...
			if (maybeRoute.a.$ === 'Top') {
				...
				var _v2 = A3(
					...
					A2($elm$core$Maybe$withDefault, 'a', model.env.token),
					1,
					model.env);
				var topModel = _v2.a;
				var topCmd = _v2.b;
				...
				var _v4 = A2($author$project$Page$Account$init, 'aaa', 1);
				var accountModel = _v4.a;
				var accountCmd = _v4.b;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							page: $author$project$Main$Account(accountModel)
						}),
					A2($elm$core$Platform$Cmd$map, $author$project$Main$AccountMsg, accountCmd));
			}
		}
	});
...
var $author$project$Route$Account = {$: 'Account'};
...
var $author$project$Main$init = F3(
	function (env, url, key) {
		return A2(
			$author$project$Main$goTo,
			$author$project$Route$parse(url),
			A3($author$project$Main$Model, key, $author$project$Main$NotFound, env));
	});
	...
	function (msg, model) {
		switch (msg.$) {
			...
			case 'TopMsg':
				...
				if (_v2.$ === 'Top') {
					var topModel = _v2.a;
					var _v3 = A2($author$project$Page$Top$update, topMsg, topModel);
					var newModel = _v3.a;
					var newCmd = _v3.b;
					return _Utils_Tuple2(
						_Utils_update(
			...
			default:
				var accountMsg = msg.a;
				var _v4 = model.page;
				if (_v4.$ === 'Account') {
					var accountModel = _v4.a;
					var _v5 = A2($author$project$Page$Account$update, accountMsg, accountModel);
					var newModel = _v5.a;
					var newCmd = _v5.b;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								page: $author$project$Main$Account(newModel)
							}),
						A2($elm$core$Platform$Cmd$map, $author$project$Main$AccountMsg, newCmd));
				} else {
					return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
				}
		}
		...
		body: _List_fromArray(
			[
				...
				switch (_v0.$) {
					...
					default:
						var accountModel = _v0.a;
						return A2(
							$elm$html$Html$map,
							$author$project$Main$AccountMsg,
							$author$project$Page$Account$view(accountModel));
				}
			}()
			]),
		title: 'midas'
